...
def G(z, i,*par,LnSRS,box=False,l=None):
    class Error_In_Box(Exception):
        pass 
    class Need_to_input_l(Exception):
        pass
...
#    LnSRS=nSRS(J)
    ...
    if box is False:           
        ...
        if l is None:
            raise Need_to_input_l("You want to use finite volume but you are not \
                                  inputting 'l' as the last variable of G ")
        import os,sys
        import Gfinite
